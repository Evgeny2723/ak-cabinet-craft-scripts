...
$("#direct-form").validate({
  rules: { name: { required: true }, phone: { required: true, phoneUS_complete: true }, email: { required: true, email_strict: true },  address: { required: true }, time: { required: true } },
  messages: { email: { email: "Invalid email" } },
  errorPlacement: function(error, element) { error.appendTo(element.closest(".input-wrapper")); },
...
$("#price-form").validate({
  rules: { 'p-name': { required: true }, 'p-phone': { required: true, phoneUS_complete: true },  'p-address': { required: true }, 'p-email': { required: true, email_strict: true }, 'p-time': { required: true } },
